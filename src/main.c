...
static int (*const kvm_msr_readable[])() = {
        ...
        [46]             = test_hv_x64_msr_reset,
        [47]             = test_hv_x64_msr_vp_runtime,
        [48]             = test_hv_x64_msr_time_ref_count,
        [49]             = test_hv_x64_msr_tsc_frequency,
        [50]             = test_hv_x64_msr_apic_frequency,
        [51]             = test_hv_x64_msr_crash_p0,
        [52]             = test_hv_x64_msr_crash_p1,
        [53]             = test_hv_x64_msr_crash_p2,
        [54]             = test_hv_x64_msr_crash_p3,
        [55]             = test_hv_x64_msr_crash_p4,
        [56]             = test_hv_x64_msr_crash_ctl,
/* FIXME: Can't compile       [46]             = test_hv_x64_msr_crash_ctl_notify, */
        [57]             = test_hv_x64_msr_crash_params
};

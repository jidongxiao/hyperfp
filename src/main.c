...
static int (*const kvm_msr_readable[])() = {
        ...
        [52]             = test_msr_ia32_vmx_vmfunc,
        [53]             = test_hv_x64_msr_reset,
        [54]             = test_hv_x64_msr_vp_runtime,
        [55]             = test_hv_x64_msr_time_ref_count,
        [56]             = test_hv_x64_msr_tsc_frequency,
        [57]             = test_hv_x64_msr_apic_frequency,
        [58]             = test_hv_x64_msr_crash_p0,
        [59]             = test_hv_x64_msr_crash_p1,
        [60]             = test_hv_x64_msr_crash_p2,
        [61]             = test_hv_x64_msr_crash_p3,
        [62]             = test_hv_x64_msr_crash_p4,
        [63]             = test_hv_x64_msr_crash_ctl,
/* FIXME: Can't compile       [46]             = test_hv_x64_msr_crash_ctl_notify, */
        [64]             = test_hv_x64_msr_crash_params
};

...
static int (*const kvm_msr_readable[])() = {
        ...
        [46]             = test_msr_ia32_vmx_basic,
        [47]             = test_msr_ia32_vmx_pinbased_ctls,
        [48]             = test_msr_ia32_vmx_procbased_ctls,
        [49]             = test_msr_ia32_vmx_exit_ctls,
        [50]             = test_msr_ia32_vmx_entry_ctls,
        [51]             = test_msr_ia32_vmx_misc,
        [52]             = test_msr_ia32_vmx_cr0_fixed0,
        [53]             = test_msr_ia32_vmx_cr0_fixed1,
        [54]             = test_msr_ia32_vmx_cr4_fixed0,
        [55]             = test_msr_ia32_vmx_cr4_fixed1,
        [56]             = test_msr_ia32_vmx_vmcs_enum,
        [57]             = test_msr_ia32_vmx_procbased_ctls2,
        [58]             = test_msr_ia32_vmx_ept_vpid_cap,
        [59]             = test_msr_ia32_vmx_true_pinbased_ctls,
        [60]             = test_msr_ia32_vmx_true_procbased_ctls,
        [61]             = test_msr_ia32_vmx_true_exit_ctls,
        [62]             = test_msr_ia32_vmx_true_entry_ctls,
        [63]             = test_msr_ia32_vmx_vmfunc,
        [64]             = test_hv_x64_msr_reset,
        [65]             = test_hv_x64_msr_vp_runtime,
        [66]             = test_hv_x64_msr_time_ref_count,
        [67]             = test_hv_x64_msr_tsc_frequency,
        [68]             = test_hv_x64_msr_apic_frequency,
        [69]             = test_hv_x64_msr_crash_p0,
        [70]             = test_hv_x64_msr_crash_p1,
        [71]             = test_hv_x64_msr_crash_p2,
        [72]             = test_hv_x64_msr_crash_p3,
        [73]             = test_hv_x64_msr_crash_p4,
        [74]             = test_hv_x64_msr_crash_ctl,
/* FIXME: Can't compile       [46]             = test_hv_x64_msr_crash_ctl_notify, */
        [75]             = test_hv_x64_msr_crash_params
};

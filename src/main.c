...
static int (*const kvm_msr_readable[])() = {
        ...
        [47]             = test_msr_ia32_vmx_vmfunc,
        [48]             = test_hv_x64_msr_reset,
        [49]             = test_hv_x64_msr_vp_runtime,
        [50]             = test_hv_x64_msr_time_ref_count,
        [51]             = test_hv_x64_msr_tsc_frequency,
        [52]             = test_hv_x64_msr_apic_frequency,
        [53]             = test_hv_x64_msr_crash_p0,
        [54]             = test_hv_x64_msr_crash_p1,
        [55]             = test_hv_x64_msr_crash_p2,
        [56]             = test_hv_x64_msr_crash_p3,
        [57]             = test_hv_x64_msr_crash_p4,
        [58]             = test_hv_x64_msr_crash_ctl,
/* FIXME: Can't compile       [46]             = test_hv_x64_msr_crash_ctl_notify, */
        [59]             = test_hv_x64_msr_crash_params
};
